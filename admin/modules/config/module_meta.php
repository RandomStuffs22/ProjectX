...
function config_meta()
{
	...
	// This is a ProjectX patch. It splits the config menu into two rows to avoid overflowing related issues. Here begins the first row...
	$sub_menu = array();
	...
	$sub_menu = $plugins->run_hooks("admin_config_menu_sup", $sub_menu);
...
function config_action_handler($action)
{
	...
	// and here the second row! The hook for external plugins has been put here because there are less elements than in the first row.
	$sub_menu = array();
